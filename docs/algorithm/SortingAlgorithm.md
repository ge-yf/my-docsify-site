...
![堆排序](./resource/HeapSort.gif)

### 7.3 代码实现

注意：这里用到了完全二叉树的部分性质：详情见[数据结构二叉树知识点总结](./resource/BinaryTree.md)
...
佳情况：T(n) = O(nlogn) 最差情况：T(n) = O(nlogn) 平均情况：T(n) = O(nlogn)
...
![计数排序](./resource/CountingSort.gif)
